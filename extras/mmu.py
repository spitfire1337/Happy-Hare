...
class Mmu:
    ...
    def handle_connect(self):
        ...
        for el in self.moonrakerConfig:
            self._log_info("Moonraker config item: %s" % repr(el))
...
####################################
    ...
    def get_status(self, eventtime):
        return {
                ...
                'gate_spoolman': list(self.gate_spoolman) if self.mmu_spoolman==1 else [],
